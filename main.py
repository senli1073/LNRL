...
def get_args():
    ...
    # For LNRL
    parser.add_argument("--sigma", type=int, default=600, metavar="SIGMA",
    ...
    # Model
    parser.add_argument("--model-name", default="lnrl", type=str, metavar="MODEL_NAME",
    ...
    # Dataset
    parser.add_argument("--data", default="/root/data/Datasets/SOS/all", metavar="DATA", type=str,
                        help="path to dataset")
    parser.add_argument("--dataset-name", default="sos", type=str, metavar="DATASET_NAME",
    ...
    # Data preprocess
    parser.add_argument("--in-samples", default=6000, type=int, metavar="IN_SAMPLES",
                        help="the length of input data (default: 6000)")
    parser.add_argument("--label-width", type=float, default=0.1, metavar="LABEL_WIDTH",
    ...
    parser.add_argument("--batch-size", default=300, type=int, metavar="BATCH_SIZE",
    ...
    # Val/Test
    parser.add_argument("--time-threshold", default=0.05, type=float, metavar="TIME_THRESHOLD",
